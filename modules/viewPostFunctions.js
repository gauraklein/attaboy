...
// console.log(comments, 'this is comments from renderSinglePost')
  ...
  return `
    <div class="card border border-secondary">
      <div class="card-body border border-primary">
          ...
          <footer class="blockquote-footer">posted by: <a href="/users/${postFromDb.user_slug}">${
            postFromDb.username
          }</a> <cite>total attaboys: ${postFromDb.total_attaboys}</cite></footer>
